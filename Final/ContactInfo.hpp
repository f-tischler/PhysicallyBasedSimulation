...
struct contact_info
{
    contact_info(physical_object& point_owner, const point_t& point, physical_object& line_owner, const line_t& line,
        double penetration_depth, const Vector2d& point_of_intersection)
