...
public:
    ...
    point_t line_start_point() const { return line_owner_.points()[std::get<0>(line_)]; }
    point_t line_end_point() const { return line_owner_.points()[std::get<1>(line_)]; }
    ...
    point_t contact_point() const { return point_; }
    Vector2d contact_point_offset() const { return std::get<0>(point_); }
    Vector2d contact_point_velocity() const { return std::get<1>(point_); }
